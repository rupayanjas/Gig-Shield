...
const Register = () => {
  ...
  const handleRegister = (e) => {
    e.preventDefault();
    if (phone) {
      // Mock registration always succeeds in demo if phone is provided
      login(phone, 'Blinkit');
      navigate('/dashboard');
    }
  };

  const handleUpiRegister = () => {
    // Quick demo register
  ...
  return (
    <div className="min-h-screen flex flex-col pt-24 bg-brand-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-brand-200 rounded-full blur-[100px] opacity-30 -translate-y-1/2 -translate-x-1/3"></div>
        ...
        <ScrollReveal direction="down" className="w-full relative z-10 flex flex-col items-center">
          <div className="text-center mb-10 w-full">
            ...
            <p className="text-brand-800 text-lg">
              Create an account and shield your earnings today.
            </p>
          </div>
        </ScrollReveal>
